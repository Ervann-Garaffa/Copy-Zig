...
pub const RL_MALLOC = @compileError("unable to translate macro: undefined identifier `malloc`"); // C:\Dev\Github\Copy Zig\raylib/raylib.h:122:13
pub const RL_CALLOC = @compileError("unable to translate macro: undefined identifier `calloc`"); // C:\Dev\Github\Copy Zig\raylib/raylib.h:125:13
pub const RL_REALLOC = @compileError("unable to translate macro: undefined identifier `realloc`"); // C:\Dev\Github\Copy Zig\raylib/raylib.h:128:13
pub const RL_FREE = @compileError("unable to translate macro: undefined identifier `free`"); // C:\Dev\Github\Copy Zig\raylib/raylib.h:131:13
