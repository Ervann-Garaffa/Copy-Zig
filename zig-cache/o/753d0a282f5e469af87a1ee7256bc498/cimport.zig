...
pub const va_start = @compileError("unable to translate macro: undefined identifier `__builtin_va_start`"); // c:\Users\Ervan\AppData\Roaming\Code\User\globalStorage\ziglang.vscode-zig\zig_install\lib\include/stdarg.h:33:9
pub const va_end = @compileError("unable to translate macro: undefined identifier `__builtin_va_end`"); // c:\Users\Ervan\AppData\Roaming\Code\User\globalStorage\ziglang.vscode-zig\zig_install\lib\include/stdarg.h:35:9
pub const va_arg = @compileError("unable to translate macro: undefined identifier `__builtin_va_arg`"); // c:\Users\Ervan\AppData\Roaming\Code\User\globalStorage\ziglang.vscode-zig\zig_install\lib\include/stdarg.h:36:9
pub const __va_copy = @compileError("unable to translate macro: undefined identifier `__builtin_va_copy`"); // c:\Users\Ervan\AppData\Roaming\Code\User\globalStorage\ziglang.vscode-zig\zig_install\lib\include/stdarg.h:41:9
pub const va_copy = @compileError("unable to translate macro: undefined identifier `__builtin_va_copy`"); // c:\Users\Ervan\AppData\Roaming\Code\User\globalStorage\ziglang.vscode-zig\zig_install\lib\include/stdarg.h:46:9
pub const RL_MALLOC = @compileError("unable to translate macro: undefined identifier `malloc`"); // C:\Dev\Github\Hero Realms\raylib/raylib.h:122:13
pub const RL_CALLOC = @compileError("unable to translate macro: undefined identifier `calloc`"); // C:\Dev\Github\Hero Realms\raylib/raylib.h:125:13
pub const RL_REALLOC = @compileError("unable to translate macro: undefined identifier `realloc`"); // C:\Dev\Github\Hero Realms\raylib/raylib.h:128:13
pub const RL_FREE = @compileError("unable to translate macro: undefined identifier `free`"); // C:\Dev\Github\Hero Realms\raylib/raylib.h:131:13
